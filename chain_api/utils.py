...
def request_post(req_data, is_assert=True, is_wallet_rpc=False):
...
def generate_random_words():
    ...
    suggest_brain_key = json.loads(requests.post(node_rpc_url, data = json.dumps(req_data), headers = headers).text)['result']
