...
test_account = 'nathan'
test_account_key = '5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3' 
test_balance_address = '5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3' 
...
def node_clean():
    ...
    cmd_exec(cmd)
    cmd = 'rm -rf {} *.log {} {}'.format(node_data_dir, node_bin_filename, wallet_bin_filename)
    cmd_exec(cmd)
