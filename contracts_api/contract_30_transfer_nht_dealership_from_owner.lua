function test_transfer_nht_dealership_from_owner(to, token_hash_or_id, enable_logger)
    chainhelper:log("to: " .. to .. ", token_hash_or_id: " .. token_hash_or_id)
    chainhelper:transfer_nht_dealership_from_owner(to, token_hash_or_id, enable_logger)
end
